...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull ConstraintLayout rootView,
      @NonNull AppCompatTextView tvAppName) {
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.tv_app_name;
      AppCompatTextView tvAppName = ViewBindings.findChildViewById(rootView, id);
      if (tvAppName == null) {
        break missingId;
      }

      return new FragmentSplashBinding((ConstraintLayout) rootView, tvAppName);
    }
